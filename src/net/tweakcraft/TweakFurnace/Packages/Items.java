...
public class Items {
    ...
    private final static List<Integer> smeltables = Arrays.asList(new Integer[]{Material.LOG.getId(),Material.IRON_ORE.getId(), Material.GOLD_ORE.getId(), Material.DIAMOND_ORE.getId(), Material.CACTUS.getId(), Material.COBBLESTONE.getId(), Material.SAND.getId(), Material.CLAY_BALL.getId(), Material.RAW_FISH.getId(), Material.PORK.getId(), Material.RAW_BEEF.getId(), Material.RAW_CHICKEN.getId()});
